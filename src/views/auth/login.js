    ...
    return (
        <div id="login-view">
            <div className="login-header">
                <a href="https://app.friotermia.com">Volver a friotermia</a>
            ...
            <div className="login-body">
                ...
                <form id="login-form" noValidate>
                    ...
                    <div className="form-group">
                        ...
                        <span className="invalid-tooltip">email inválido</span>
                        <input type="email" placeholder="Ingesa tu email" id="login-email"/>
                    </div>
                    {/* pasword field */}
                    <div className="form-group">
                        <label for="login-passw">CONTRASEÑA</label>
                        <span className="invalid-tooltip">contraseña inválida</span>
                        <input type="password" placeholder="Ingresa tu contraseña" id="login-passw"/>
                    </div>
                    {/* dubmit button */}
                    <button className="btn btn-success" type="submit" disabled="true">Iniciar Sesión</button>
                </form>
            </div>
